...
TARGET_PLATFORM_REPO=https://airtake-public-data-1254153901.cos.ap-shanghai.myqcloud.com/smart/embed/pruduct/linux-ubuntu-6.2.0_64Bit_1.0.2.zip
TARGET_PLATFORM_VERSION=1.0.2
ROOT_DIR=$(pwd)
