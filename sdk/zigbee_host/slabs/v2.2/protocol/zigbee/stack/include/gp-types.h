...
/*typedef struct {
   // "totalNbOfOptionRecord" is not a offical field of the Translation table,
   // it is created to easier parse all OptionRecord of one particular TT entry
   uint8_t       totalNbOfOptionRecord;
   EmberGpTranslationTableAdditionalInfoBlockOptionRecordField optionRecord[TT_NB_MAX_OPTION_RECORD];
