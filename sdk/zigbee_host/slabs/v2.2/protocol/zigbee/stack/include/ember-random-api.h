 ...
 */
EmberStatus emberGetTrueRandomNumberArray(uint16_t *randomNumber, uint8_t count);

/** @brief Used to get one true random number.
 *         For more info check ::emberGetTrueRandomNumberArray.
 */
#define emberGetTrueRandomNumber(randomNumber) \
  (emberGetTrueRandomNumberArray((randomNumber), 1))
 ...
 */
EmberEntropySource emberGetTrueRandomEntropySource(void);
