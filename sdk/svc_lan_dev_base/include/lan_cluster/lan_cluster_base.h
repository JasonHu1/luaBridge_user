...
#define MASTER_KEEPALIVE_CHECK_NUM   	4  		//普通节点判断master离线的 周期个数
...
VOID lan_cluster_master_confirm_msg_st2json(IN CONST LAN_NODE_S *msg_node, IN INT_T ka_seq, IN CHAR_T msg_json[MST_CFM_MSG_MAX_LEN]);
OPERATE_RET lan_cluster_master_confirm_msg_json2st(IN CONST CHAR_T *msg_json, OUT LAN_NODE_S *msg_node, OUT INT_T *out_ka_seq);
...
OPERATE_RET lan_setup_udp_client_socket(OUT INT_T *fd_out);
